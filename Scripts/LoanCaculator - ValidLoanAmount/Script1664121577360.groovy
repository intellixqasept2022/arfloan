...
WebUI.click(findTestObject('Object Repository/Page_/a_Calculator'))

WebUI.setText(findTestObject('Object Repository/Page_/input__ctl00MainContenttxtLoanAmount'), LoanAmount)

WebUI.click(findTestObject('Object Repository/Page_/a_Calculate'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_/span_150'), MonthlyPayment)
