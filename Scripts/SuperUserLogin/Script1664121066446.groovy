...
WebUI.setText(findTestObject('Object Repository/Page_Home Page/input_User Name_ctl00MainContenttxtUserName'), 'straining')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_/a_Admin Home Page'), 'Admin Home Page')
